...
def differential_evolution(func, bounds, mut=0.8, crossp=0.7, popsize=100, max_iter=1_000):
...
def pso(func, bounds, a1 = 1.5, a2 = 1.5, pop_size=100, max_iter=1_000, viz=False):
    SWRM = []
    BP = []
    BSF = []
    # particles
